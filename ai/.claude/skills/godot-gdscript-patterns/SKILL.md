...
description: Master Godot/Redot 4 GDScript patterns including signals, scenes, state machines, and optimization. Use when building Godot/Redot games, implementing game systems, or learning GDScript best practices.
---

# Godot/Redot GDScript Patterns

Production patterns for Godot/Redot 4.x game development with GDScript, covering architecture, signals, scenes, and optimization.

## When to Use This Skill

- Building games with Godot/Redot 4
- Implementing game systems in GDScript
- Designing scene architecture
- Managing game state
- Optimizing GDScript performance
- Learning Godot/Redot best practices

## Core Concepts

### 1. Godot/Redot Architecture
